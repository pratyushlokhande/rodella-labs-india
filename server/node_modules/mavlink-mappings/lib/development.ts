 ...
 */
export class AvailableModes extends MavLinkData {
  static MSG_ID = 435
  static MSG_NAME = 'AVAILABLE_MODES'
  static PAYLOAD_LENGTH = 58
  static MAGIC_NUMBER = 94

  static FIELDS = [
    new MavLinkPacketField('custom_mode', 'customMode', 0, false, 4, 'uint32_t', ''),
    new MavLinkPacketField('number_modes', 'numberModes', 4, false, 1, 'uint8_t', ''),
    new MavLinkPacketField('mode_index', 'modeIndex', 5, false, 1, 'uint8_t', ''),
    new MavLinkPacketField('standard_mode', 'standardMode', 6, false, 1, 'uint8_t', ''),
    new MavLinkPacketField('base_mode', 'baseMode', 7, false, 1, 'uint8_t', ''),
    new MavLinkPacketField('mode_name', 'modeName', 8, false, 1, 'char[]', '', 50),
  ]
 ...
 */
export class CurrentMode extends MavLinkData {
  static MSG_ID = 436
  static MSG_NAME = 'CURRENT_MODE'
  static PAYLOAD_LENGTH = 6
  static MAGIC_NUMBER = 151

  static FIELDS = [
    new MavLinkPacketField('custom_mode', 'customMode', 0, false, 4, 'uint32_t', ''),
    new MavLinkPacketField('standard_mode', 'standardMode', 4, false, 1, 'uint8_t', ''),
