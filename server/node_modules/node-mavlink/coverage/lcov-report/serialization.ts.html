...
<head>
    <title>Code coverage report for serialization.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> serialization.ts</h1>
        <div class='clearfix'>
...
export const SERIALIZERS = {
  // special types
  'uint8_t_mavlink_version': <span class="fstat-no" title="function not covered" >(v</span>alue: uint8_t, buffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.writeUInt8(value, offset),</span>
&nbsp;
  // singular types
  ...
  'int64_t' : <span class="fstat-no" title="function not covered" >(v</span>alue: int64_t, buffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.writeBigInt64LE(value, offset),</span>
  'uint64_t': <span class="fstat-no" title="function not covered" >(v</span>alue: uint64_t, buffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.writeBigUInt64LE(value, offset),</span>
...
&nbsp;
  ...
  'int64_t[]': <span class="fstat-no" title="function not covered" >(v</span>alue: uint64_t[], buffer: Buffer, offset: number, maxLen: number) =&gt; {
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; value.length &amp;&amp; i &lt; maxLen; i++) {</span>
<span class="cstat-no" title="statement not covered" >      buffer.writeBigInt64LE(value[i], offset + i * 8)</span>
    }
  },
  'uint64_t[]': <span class="fstat-no" title="function not covered" >(v</span>alue: uint64_t[], buffer: Buffer, offset: number, maxLen: number) =&gt; {
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; value.length &amp;&amp; i &lt; maxLen; i++) {</span>
<span class="cstat-no" title="statement not covered" >      buffer.writeBigUInt64LE(value[i], offset + i * 8)</span>
    }
  },
...
export const DESERIALIZERS = {
  // special types
  'uint8_t_mavlink_version': <span class="fstat-no" title="function not covered" >(b</span>uffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.readUInt8(offset),</span>
&nbsp;
  // singular types
  ...
  'int64_t' : <span class="fstat-no" title="function not covered" >(b</span>uffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.readBigInt64LE(offset),</span>
  'uint64_t': <span class="fstat-no" title="function not covered" >(b</span>uffer: Buffer, offset: number) =&gt; <span class="cstat-no" title="statement not covered" >buffer.readBigUInt64LE(offset),</span>
...
&nbsp;
  ...
  'int64_t[]': <span class="fstat-no" title="function not covered" >(b</span>uffer: Buffer, offset: number, length: number) =&gt; {
    const result = <span class="cstat-no" title="statement not covered" >new Array&lt;BigInt&gt;(length)</span>
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; length; i++) <span class="cstat-no" title="statement not covered" >result[i] = buffer.readBigInt64LE(offset + i * 8)</span></span>
<span class="cstat-no" title="statement not covered" >    return result</span>
  },
  'uint64_t[]': <span class="fstat-no" title="function not covered" >(b</span>uffer: Buffer, offset: number, length: number) =&gt; {
    const result = <span class="cstat-no" title="statement not covered" >new Array&lt;BigInt&gt;(length)</span>
<span class="cstat-no" title="statement not covered" >    for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; length; i++) <span class="cstat-no" title="statement not covered" >result[i] = buffer.readBigUInt64LE(offset + i * 8)</span></span>
<span class="cstat-no" title="statement not covered" >    return result</span>
  },
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Mar 29 2022 21:47:11 GMT+0200 (Central European Summer Time)
            </div>
